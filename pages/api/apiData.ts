...
//       } catch (error) {
//         console.error(
//           `Error while processing ${currentUrl}: ${(error as Error).message}`
//         );
//         allWebsitesData.push({
//           mainPageUrl: startUrl,
//           foundEmailsUrls: [],
//           error: `Error while processing ${currentUrl}: ${
...
//     res.status(200).json({ websites: allWebsitesData });
//   } catch (error) {
//     console.error(`Error while crawling websites: ${(error as Error).message}`);
//     res.status(500).json({ message: "Internal Server Error" });
//   }
// }
